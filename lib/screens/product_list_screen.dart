    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          Stack(
            ...
            children: [
              PulseAnimation(
                // Apply pulsing animation to the cart icon when there are items
                duration: const Duration(milliseconds: 1500),
                minScale: 1.0,
                maxScale: 1.1,
                repeat: true,
                // Only animate when there are items in the cart
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            // Header gradient container with slide in animation
            SlideInAnimation(
