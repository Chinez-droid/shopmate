              ...
              child: Column(
                ...
                children: [
                  ...
                  SlideInAnimation(
                    ...
                    delay: true,
                    curve: Curves.easeOutQuint,
                    child: const SectionHeader(title: 'Your Shopping Sessions'),
                  ),
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return SlideInAnimation(
                          ...
                          child: SessionCard(
                            ...
                            onTap: () {
                              // In a real implementation, this would navigate to session details
                              // Here we'll just provide feedback
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text('Opening ${session.name}'),
